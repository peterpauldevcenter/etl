...
def build_database():
    ...
    map_test_data = [
        ...
        data_directory / pathlib.Path('MAP Testing Data - Winter (before manipulation).xlsx')
    ]
    report_card_data = [
    ...
    peter_paul_roster_data = [data_directory / pathlib.Path('Student Roster with Markel IDs Corrected.xlsx')]
